...
if __name__ == '__main__':
    ...
    data = '[ {"op": "replace", "path": "/description", "value": "yinpeng update Plan" } ]'

    response = requests.patch('https://api-m.sandbox.paypal.com/v1/billing/plans/P-16T534592Y776154BMLL44GY', headers=get_test_http_headers(), data=data)
